...
mymodel = tf.keras.models.load_model('C:/Users/hemanth/Desktop/sop/SQL-Injection-Detection-main/my_model_cnn.h5')

myvectorizer = pickle.load(open("C:\\Users\\hemanth\\Desktop\\sop\\SQL-Injection-Detection-main\\vect_cnn_2", 'rb'))
...
def main():
    ...
    st.subheader(
        "The primary goal of this project is to identify whether the inserted data by users contains SQLi vulnerabilities.")
